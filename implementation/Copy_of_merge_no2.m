function Copy_of_merge_no2(start_date, end_date, lat_bounds, lon_bounds, tempo_input_path, tropomi_input_path, data_save_path, options)
    arguments
        start_date string
        end_date string
        lat_bounds double
    ...
    for i = 1:length(run_days)
        ...
        C = C + C' + speye(n,n);
        matrix_image(C, 'correlation matrix', 'C:\Users\tely1\OneDrive\Desktop\test.png', 'hot');
