...
load('/mnt/disks/data-disk/data/time_series/time_series_data.mat');
...
save_path = fullfile('/mnt/disks/data-disk/NERTO_2024/validation', 'correlation.mat');
...
if exist(save_path, "file")
    ...
    merged_data = table2timetable(merged_data_table(:, {'time', 'Site', 'TEMPO_NO2', 'Merged_NO2'}));
    tropomi_data = table2timetable(tropomi_data_table(:, {'time', 'Site', 'TROPOMI_NO2'}));
    ...
    for i = 1:length(sites)
        ...
        synchronized_timetable = synchronize(pandora_site, merged_site, tropomi_site, 'regular', 'mean', 'TimeStep', minutes(30));
...
fig_save_path = '/mnt/disks/data-disk/figures/validation/correlation';
...
for i = 1:length(sites)
    ...
    create_and_save_fig_scatter_lines(input, fig_save_path, filename, site, {'TEMPO', 'TROPOMI', 'Merged'}, 'PANDORA tropospheric NO2 (umol/m^2)', 'Satellite tropospheric NO2 (umol/m^2)', [], []);
    % break
end
...
for i = 1:3
    ...
    create_and_save_fig_scatter_lines(input, fig_save_path, filename, current_case, {'TEMPO', 'TROPOMI', 'Merged'}, 'PANDORA tropospheric NO2 (umol/m^2)', 'Satellite tropospheric NO2 (umol/m^2)', [], []);
    % break
end
