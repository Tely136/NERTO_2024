...
save_folder = '/mnt/disks/data-disk/figures/validation/uncertainty'; % need to change this save fplder to be outside pf the git repo
...
start_day = datetime(2023,8,1,"TimeZone", plot_timezone);
end_day = datetime(2024,7,31, "TimeZone", plot_timezone);
...
switch overwrite
    case true
        ...
        for i = 1:n_tempo
            ...
            save('/mnt/disks/data-disk/NERTO_2024/validation/uncertanties.mat', "tempo_*", "tropomi_*");

        case false
            load('/mnt/disks/data-disk/NERTO_2024/validation/uncertanties.mat')
end
...
scatter_plot([tempo_s_binned tropomi_s_binned], [tempo_u_binned_s tropomi_u_binned_s], [tempo_u_error_s, tropomi_u_error_s], save_folder, 's_error.png', 'error', 'NO2 Retrieval Uncertainty Against Geometric Air Mass Factor', {'TEMPO', 'TROPOMI'}, 'sec(VZA) + sec(SZA)', 'Uncertainty [umoles/m^2]')
...
scatter_plot([tempo_s_binned tropomi_s_binned], [tempo_u_binned_s tropomi_u_binned_s], [tempo_u_error_s, tropomi_u_error_s], save_folder, 's.png', 'reg', 'NO2 Retrieval Uncertainty Against Geometric Air Mass Factor', {'TEMPO', 'TROPOMI'}, 'sec(VZA) + sec(SZA)', 'Uncertainty [umoles/m^2]')
